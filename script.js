/* =========================
        ...
        function genVectores() {
            ...
            for (const ax of [-2, 1, 3], ay of[-1, 2, 4], bx of[1, 2, -3], by of[0, 3, -2]) {
        ...
        function newAttempt() {
            ...
            hintEl.textContent = "Presiona “Iniciar”. Reiniciar crea un examen nuevo con 40 aleatorias de TODO el banco.";
            ...
            bankInfo.textContent =
                `Banco total cargado: ${BANK.length} preguntas.\n` +
                `Matemáticas: ${by.Matemáticas} • Lenguaje: ${by.Lenguaje} • Física: ${by.Física}\n` +
                `Cada reinicio toma 40 aleatorias de TODO el banco.`;
        }
